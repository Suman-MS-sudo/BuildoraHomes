...
export default function App() {
  ...
  return (
    <>
        ...
        <div className="footer-cta-band">
          <div className="footer-cta-inner">
            ...
            <div className="footer-cta-btns">
              ...
              <a href="https://wa.me/917538839958" target="_blank" rel="noreferrer" className="btn-wa">WhatsApp</a>
            </div>
          </div>
        </div>
      ...
      <a href="https://wa.me/917538839958" target="_blank" rel="noreferrer" className="wa-fab" aria-label="Chat on WhatsApp">
      ...
      <div className="mob-bar">
        ...
        <a href="https://wa.me/917538839958" target="_blank" rel="noreferrer" className="mob-btn mob-wa">
