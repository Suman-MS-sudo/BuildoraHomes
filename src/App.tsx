...
const SERVICES = [
  ...
  { icon: "zap",      cat: "MEP",        label: "Electrical Wiring",          desc: "Full Polycab ISI-standard electrical installation",  price: "₹35/sq ft" },
  { icon: "droplet",  cat: "MEP",        label: "Plumbing (General)",         desc: "General plumbing work with ISI fittings",           price: "₹10,000/point" },
  { icon: "faucet",   cat: "MEP",        label: "Plumbing (Kitchen)",         desc: "Kitchen plumbing — sink, outlet, inlet lines",      price: "₹7,000/point" },
  { icon: "toilet",   cat: "MEP",        label: "Plumbing (Toilet)",          desc: "Toilet plumbing, EWC & health-faucet points",       price: "₹10,000/point" },
  { icon: "tile",     cat: "Finishes",   label: "Tiles Laying",               desc: "Floor & wall tile laying with grout finish",        price: "₹25–₹50/sq ft" },
  { icon: "brush",    cat: "Finishes",   label: "Painting",                   desc: "Interior emulsion & exterior weather-coat paint",   price: "₹6–₹10/sq ft" },
  { icon: "glass",    cat: "Finishes",   label: "Glassing",                   desc: "Toughened glass panels, windows & partitions",     price: "₹30/sq ft" },
  { icon: "brick9",   cat: "Finishes",   label: "Brick Walling (9\")",        desc: "9-inch thick solid Red Brick load-bearing wall",   price: "₹35/sq ft" },
  { icon: "brick4",   cat: "Finishes",   label: "Brick Walling (4\")",        desc: "4-inch partition Red Brick wall construction",     price: "₹30/sq ft" },
];
    ...
    <>
      ...
      <section className="pricing-section" id="pricing">
        <div className="section-head">
          ...
          <p className="section-sub">Three clearly defined construction packages — each listing the exact materials and brands used, so you know precisely what you are getting.</p>
        </div>
          ...
          <div className="pricing-card">
            <div className="pricing-card-img-wrap">
              <img
                ...
                alt="Essential home — Package 1"
                className="pricing-card-img"
                loading="lazy"
              />
              <div className="pricing-card-img-overlay">
                <span className="pricing-card-tier-tag">Package 1</span>
              </div>
            </div>
            <div className="pricing-header">
              <div className="pricing-tier-icon">
                <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
              </div>
              <h3 className="pricing-title">Package 1 — Essential</h3>
              <div className="pricing-price">
                <span className="price-amount">₹1,999</span>
                <span className="price-unit">/sq ft</span>
              </div>
              <p className="pricing-desc">Quality construction with ISI-certified materials, AAC or Red Brick structure, and comprehensive wiring &amp; fittings.</p>
            </div>
            <ul className="pricing-features">
              <li><CheckIcon /><span><strong>Sand:</strong> M-Sand or R-Sand</span></li>
              <li><CheckIcon /><span><strong>Cement:</strong> UltraTech or Priya Cement</span></li>
              <li><CheckIcon /><span><strong>Steel:</strong> TMT Fe 550 — ISI Certified</span></li>
              <li><CheckIcon /><span><strong>Blocks:</strong> AAC Blocks or Red Brick</span></li>
              <li><CheckIcon /><span><strong>Tiles:</strong> Standard quality flooring</span></li>
              <li><CheckIcon /><span><strong>Electrical:</strong> ISI standard — Polycab wiring</span></li>
              <li><CheckIcon /><span><strong>Plumbing:</strong> ISI standard fittings</span></li>
              <li><CheckIcon /><span><strong>Fixtures:</strong> Orbit fittings &amp; comprehensive wiring</span></li>
            </ul>
          ...
          <div className="pricing-card pricing-popular">
            ...
            <div className="pricing-card-img-wrap">
              <img
                ...
                alt="Premium home — Package 2"
                className="pricing-card-img"
                loading="lazy"
              />
              <div className="pricing-card-img-overlay">
                <span className="pricing-card-tier-tag popular">Package 2</span>
              </div>
            </div>
            <div className="pricing-header">
              <div className="pricing-tier-icon">
                <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/><line x1="3" y1="9" x2="21" y2="9"/></svg>
              </div>
              <h3 className="pricing-title">Package 2 — Premium</h3>
              <div className="pricing-price">
                <span className="price-amount">₹2,199</span>
                <span className="price-unit">/sq ft</span>
              </div>
              <p className="pricing-desc">Upgraded finishes with Red Brick structure, Polycab wiring throughout, and premium Waterman plumbing fittings.</p>
            </div>
            <ul className="pricing-features">
              <li><CheckIcon /><span><strong>Sand:</strong> M-Sand or R-Sand</span></li>
              <li><CheckIcon /><span><strong>Cement:</strong> UltraTech or Priya Cement</span></li>
              <li><CheckIcon /><span><strong>Steel:</strong> TMT Fe 550 — ISI Certified</span></li>
              <li><CheckIcon /><span><strong>Blocks:</strong> Red Brick construction</span></li>
              <li><CheckIcon /><span><strong>Tiles:</strong> Standard quality flooring</span></li>
              <li><CheckIcon /><span><strong>Electrical:</strong> Polycab wiring throughout</span></li>
              <li><CheckIcon /><span><strong>Plumbing:</strong> Premium Waterman fittings</span></li>
              <li><CheckIcon /><span><strong>Fixtures:</strong> Premium standard fixtures</span></li>
            </ul>
            <a href="#client-intake" className="btn-pricing">Get Quote</a>
          </div>
          ...
          <div className="pricing-card">
            <div className="pricing-card-img-wrap">
              <img
                ...
                alt="Luxury IoT smart home — Package 3"
                className="pricing-card-img"
                loading="lazy"
              />
              <div className="pricing-card-img-overlay">
                <span className="pricing-card-tier-tag">Package 3</span>
              </div>
            </div>
            <div className="pricing-header">
              <div className="pricing-tier-icon">
                <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>
              </div>
              <h3 className="pricing-title">Package 3 — Luxury &amp; IoT</h3>
              <div className="pricing-price">
                <span className="price-amount">₹2,499</span>
                <span className="price-unit">/sq ft</span>
              </div>
              <p className="pricing-desc">Ultimate luxury with smart IoT home integration — ARS steel, Koromandal cement, granite flooring, Jaguar fittings and FRP-grade electrical.</p>
            </div>
            <ul className="pricing-features">
              <li><CheckIcon /><span><strong>Sand:</strong> M-Sand / R-Sand (slab grade)</span></li>
              <li><CheckIcon /><span><strong>Cement:</strong> UltraTech or Koromandal Cement</span></li>
              <li><CheckIcon /><span><strong>Steel:</strong> TMT Fe 550 — ARS Steel</span></li>
              <li><CheckIcon /><span><strong>Blocks:</strong> Wire-cut Red Brick / structural</span></li>
              <li><CheckIcon /><span><strong>Flooring:</strong> Granite finish throughout</span></li>
              <li><CheckIcon /><span><strong>Bathroom:</strong> Premium tiles up to ceiling</span></li>
              <li><CheckIcon /><span><strong>Electrical:</strong> Polycab ISI, FRP standard</span></li>
              <li><CheckIcon /><span><strong>Plumbing:</strong> Fenolex ISI 6 kg/cm² — Jaguar fittings</span></li>
              <li><CheckIcon /><span><strong>Smart Home:</strong> IoT automation — lights, security &amp; AC control</span></li>
            </ul>
            <a href="#client-intake" className="btn-pricing">Get Quote</a>
          </div>
      ...
      <div className="mobile-contact-bar">
        <a href="tel:+919962580581" className="mob-contact-btn mob-call">
        ...
        <a href="https://wa.me/919962580581" target="_blank" rel="noreferrer" className="mob-contact-btn mob-wa">
