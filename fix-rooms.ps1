...
# Lines 198+ = the component function (0-indexed: 197..)
$component = $allLines[197..($allLines.Length - 1)]
...
const ROOMS: Room[] = [
  ...
  },
  {
    ...
    pins: [
      ...
      "https://images.unsplash.com/photo-1593642532559-0c6d3fc62b89?w=500&q=80",
    ],
...
$combined = ($header -join "`n") + "`n" + $rooms + "`n" + ($component -join "`n")
